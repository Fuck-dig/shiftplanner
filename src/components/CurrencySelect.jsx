...
// the value itself rather than a mode flag: anything the list does not contain
// IS custom, so an existing restaurant set up before this dropdown existed
// opens with its own symbol in the text box rather than being silently
// rewritten to whatever happens to be first in the list.
...
export default function CurrencySelect({ value, onChange, disabled, placeholder, t }){
  ...
  // Without it, clearing the text would snap straight back to the dropdown
  // mid-edit.
